...
| 0.4 | Two-index write pointer (**value-vs-index drill**) | Remove duplicates from sorted array | [x] | 2026-08-27 |
...
| | Count |
|---|---|
| Phase 0 complete | 4 / 15 |
| Sheet problems ticked | 6 / 455 |
| On the re-do list | 0 |
...
| Running top-K (single-pass) | need top-K without sorting; K=2 fixed vars, general K → min-heap size K | note not yet written |
